  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 mt-3 pt-3 border-t border-slate-100 dark:border-slate-700">
        <button
          onClick={onClick}
          className="flex-1 py-2.5 bg-slate-100 dark:bg-slate-700 text-teal-600 dark:text-teal-400 rounded-xl text-sm font-bold hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors"
        >
          צפייה בפרטים
        </button>
        {showEditButton && onEdit && (
          <button
            ...
            className="flex-1 py-2.5 bg-teal-600 text-white rounded-xl text-sm font-bold hover:bg-teal-500 transition-colors"
          >
            עריכה
          </button>
        )}
