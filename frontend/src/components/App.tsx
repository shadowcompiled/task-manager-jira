              ...
              <div className="md:hidden relative">
                ...
                {showHeaderMenu && (
                  <>
                    ...
                    <div dir="rtl" className="md:hidden fixed inset-x-0 z-50 rounded-2xl mx-3 bg-slate-800 border border-teal-500/40 shadow-2xl" style={{ bottom: '76px' }}>
          ...
          {(user.role === 'manager' || user.role === 'admin' || user.role === 'maintainer') && (
            <>
              ...
              <div className="flex flex-1 justify-evenly gap-0 min-w-0">
                ...
                >
                  <span className="whitespace-nowrap">📊 סטטיסטיקה</span>
                </button>
              </div>
            </>
          )}
