  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-4 sm:p-6 pb-16 sm:pb-20 space-y-6 overflow-y-auto flex-1">
          {/* Status & Priority */}
        ...
        {/* Actions */}
        <div className="p-4 sm:p-6 pt-6 border-t border-slate-600 flex gap-3 justify-end flex-wrap pb-[max(2rem,env(safe-area-inset-bottom))] sm:pb-6">
          {isEditing ? (
            <>
              <motion.button
                type="button"
